 ...
 * 18 Dec 2019
 * Charlie SImonsson
 * This document has ben edited to remove unused files all credit for
 * the used files goes to original Author.
 */
...
namespace Collision {
    ...
    std::vector<sf::Vector2f> getPixelsOverlap(const sf::Sprite& Object1, const sf::Sprite& Object2, sf::Uint8 AlphaLimit = 0);
}
